                ...
                <div className="col-xl-6">
                  ...
                  >
                    <div className="about-right-content">
                      ...
                      <h2 className="about-title">Hi there, I’m Tony Zou</h2>
                      ...
                      <div className="about-txt mb-30">
                        <p>
                          ...
                          years experience in bringing forth expertise in
                          design, development, deployment, testing, and
                          maintenance of software systems. Able to effectively
                        ...
                        <p className="mb-0">
                          ...
                          (Linux, Apache, MySql, PHP), MERN (Mongo, Express,
                          React, Node), Laravue (Laravel, Vue). Spearheaded
                          successful transition from Dom(Document Object Model)
                          structure to SPA(Single Page Application) which cut
                          latency by 35% and increased effectiveness of database
                          administrators by 15%.
                        </p>
                      </div>
